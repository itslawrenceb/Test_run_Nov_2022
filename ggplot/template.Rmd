...
ggplot(msleep, aes(x = order)) +
geom_bar() +
theme(text = element_text(angle = 90, hjust = 1, vjust = 0.5, size = rel(1.5))) +
...
super_plot <- cowplot::plot_grid(first_row, second_row, labels = c("A", "B"), ncol = 2, nrow = 1
)
super_plot
```
...
```{r}
ggsave("new_plot.jpeg", plot = super_plot, width = 12, height = 12)
```
