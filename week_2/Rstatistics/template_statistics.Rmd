...
abline(v = mean(x) - sd(x), col = "green")
...
```{r}
Qb <- qnorm(seq(0, 1, 0.01))
Qb
plot(seq(0,1, 0.01), Qb)
...
gene_1_infected <- logcounts_matrix2[gene_index,names_infected]

names_un_infected <- cell_info$Sample[cell_info$Infection != "STM-LT2"]
gene_1_uninfected <- logcounts_matrix2[gene_index,names_un_infected]
...
print(t_test_row(index = 3, logcounts_matrix, cell_info )   )
print(t_test_row(index = 40, logcounts_matrix, cell_info )   )
```
