...
```{r}
#keytype = the type of information you are giving it
#columns = the information you want back from the database
#keys = your list of genes
...
```{r}
mapIds(x = org.Hs.eg.db, keys = human_symbols,
column = "ENSEMBL",
keytype = "SYMBOL"
)
 ```
...
```{r}
demo_se <- SummarizedExperiment( assays=SimpleList(counts = assay_counts),
