...
```{r}
seurat_after_qc <- SCTransform(seurat_after_qc, vars.to.regress = c("percent_mt", "nCount_RNA"), variable.features.n = 2000)
seurat_after_qc
```
...
```{r}
VlnPlot(seurat_after_qc, features = c("nCount_SCT", "nCount_RNA"))

VlnPlot(seurat_after_qc, features = c("nFeature_SCT", "nFeature_RNA"))
```
