...
sce <- DropletUtils::read10xCounts(
  samples = c("pbmc5k" = "raw_feature_bc_matrix"),
  col.names = TRUE
)
sce
```
...
sce_filtered_cellranger <- DropletUtils::read10xCounts(
  samples = c("pbmc5k" = "filtered_feature_bc_matrix"),
  col.names = TRUE
)
...
```
```{r}
sce_decontX_filter <- sce_decontX[, sce_decontX$decontX_contamination < 0.75]

plotReducedDim(sce_decontX_filter, dimred = "decontX_UMAP", colour_by = "decontX_contamination")
```
